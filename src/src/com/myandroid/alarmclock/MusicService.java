...
import com.myandroid.alarmclock.audio.AudioFocusHelper;
import com.myandroid.alarmclock.audio.MusicFocusable;
import com.myandroid.alarmclock.audio.MusicRetriever;
import com.myandroid.alarmclock.audio.PrepareMusicRetrieverTask;
...
public class MusicService extends Service implements OnCompletionListener, OnPreparedListener,
    ...
    // AndroidManifest.xml.
    public static final String ACTION_PLAY = "com.myandroid.alarmclock.action.PLAY";
    public static final String ACTION_PAUSE = "com.myandroid.alarmclock.action.PAUSE";
    public static final String ACTION_STOP = "com.myandroid.alarmclock.action.STOP";
    public static final String ACTION_SKIP = "com.myandroid.alarmclock.action.SKIP";
    public static final String ACTION_REWIND = "com.myandroid.alarmclock.action.REWIND";
    public static final String ACTION_URL = "com.myandroid.alarmclock.action.URL";
    ...
    void updateNotification(String text) {
        PendingIntent pi = PendingIntent.getActivity(getApplicationContext(), 0,
                new Intent(getApplicationContext(), AlarmClockActivity.class),
