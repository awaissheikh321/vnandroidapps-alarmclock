...
public class AlarmAlert extends Activity implements Alarms.AlarmSettings {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        SharedPreferences settings = getSharedPreferences(CoolAlarm.PREFERENCES, 0);
        int face = settings.getInt(CoolAlarm.PREF_CLOCK_FACE, 0);
        if (face < 0 || face >= CoolAlarm.CLOCKS.length) face = 0;
        View clockLayout = (View)mFactory.inflate(CoolAlarm.CLOCKS[face], null);
